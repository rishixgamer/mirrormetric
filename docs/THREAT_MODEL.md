...
| Hidden score assumptions | Versioned bands or features, weights or coefficients, contributions, exclusions, provenance, and range method |
...
- misleading interpretation of a project-defined 0–10 geometry score;
